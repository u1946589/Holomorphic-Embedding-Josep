...
RHS = np.r_[valor.real, valor.imag, W[pv_] - 1]  # afegir l'equació del mòdul dels PV
...
S_in = (Pfi[:] + 1j * Qfi[:])
error = S_in - S_out  # error de potències
# FI ERRORS
err = max(abs(np.r_[error[0, pqpv]]))  # màxim error de potències amb P-W
