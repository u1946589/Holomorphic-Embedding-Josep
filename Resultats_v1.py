...
df_top = pd.read_excel('IEEE118.xlsx', sheet_name='Topologia')  # DataFrame of the topology
df_bus = pd.read_excel('IEEE118.xlsx', sheet_name='Busos')  # Dataframe of the buses
